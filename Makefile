...
OBJS = args.o autotune.o matrix.o dictionary.o loss.o productquantizer.o densematrix.o quantmatrix.o vector.o model.o utils.o meter.o korean_nlp_tools.o fasttext.o
INCLUDES = -I.
...
korean_nlp_tools.o: src/korean_nlp_tools.cc src/korean_nlp_tools.h
	$(CXX) $(CXXFLAGS) -c src/korean_nlp_tools.cc
